...
<br>
       ...
       <h1> Felicidades pareja de casados </h1>
       <h2>favor de contestar esta encuesta </h2>
        <label >Nombre del esposo</label>
             <br>      
        <input type="text" class="bor" name="Nombre_Esposo">
            <br>
            <br>
         <label>Lugar de nacimiento del esposo</label>
              <br>  
        <input type="text" class="bor"  name="LugarN_esposo" >    
            <br>  
            <br>
          <label>Edad del esposo</label>
          <br>  
          <input type="number" class="bor" name="Edad_Esposo" >    
            <br>
            <br>  
           <label>Nacionalidad del esposo:</label>
           <br>  
           <input type="text" class ="bor" name="Nacionalidad_Esposo" >
              <br>
              <br>
            <label>Ocupacion del esposo:</label>
              <br>  
            <input type="text" class="bor" name="Ocupacion_Esposo" >
            <br>
            <br>
            <label>Domicilio del esposo</label>
             <br>  
            <input type="text" class="bor" name="Domicilio_Esposo" >
        ...
        <br>  
        <input type="text" class="bor"name="Nombre_Esposa" >    
        <br>
        <br>   
        <label>Lugar de nacimiento de la esposa</label>
        <br>  
        <input type="text" class="bor" name="LugarN_esposa" >    
        <br>
        <br>   
        <label>Edad de la esposa</label>
        <br>  
        <input type="number" class="bor"  name="Edad_Esposa" >    
        <br>
        <br>   
        <label>Nacionalidad de la esposa</label>
        <br>  
        <input type="text" class="bor"  name="Nacionalidad_Esposa" >    
        <br>
        <br>   
        <label>Ocupacion de la esposa</label>
        <br>  
        <input type="text"  class="bor" name="Ocupacion_Esposa" >    
        <br>  
        <br> 
        <label>Domiclio de la esposa</label>
        <br>  
        <input type="text" class="bor" name="Domicilio_Esposa" >   
        <br>
        <br>
     ...
     <br>
        ...
        <label>Nombre del padre del esposo:</label>
            <br>  
          <input type="text" class="bor" name="Nombre_Pesposo" >
          <br>
          <br> 
         <label>Nombre de la madre del esposo</label>
         <br>  
          <input type="text" class="bor"  name="Nombre_Mesposo" >    
          <br>
          <br>   
          <label>Domicilio del padre del esposo</label>
          <br>  
          <input type="text" class="bor" name="Domicilio_Pesposo" >
          <br>
          <br> 
          <label>Domiclio de la madre del esposo</label>
          <br>  
          <input type="text" class="bor" name="Domicilio_Mesposo" >    
          <br>
          <br>   
          <label>ocupacion del padre del esposo</label>
          <br>  
          <input type="text" class="bor" name="Ocupacion_Pesposo" >
          <br>
          <br> 
          <label>ocupacion de la madre del esposo</label>
          <br>  
          <input type="text" class="bor" name="Ocupacion_Mesposo" >  
             <br>
             <br>
             <br>
        ...
        <br>  
        <input type="text" class="bor"  name="Nombre_Pesposa" >
        <br>
        <br>  
        <label>Nombre de la madre de la esposa</label>
        <br>  
        <input type="text"  class="bor" name="Nombre_Mesposa" >    
        <br>  
        <br>  
        <label>Domicilio del padre de la esposa</label>
        <br>  
        <input type="text"  class="bor" name="Domicilio_Pesposa" >
        <br>
        <br>  
        <label>Domicilio de la madre de la esposa</label>
        <br>         
        <input type="text"  class="bor" name="Domicilio_Mesposa" >  
        <br>  
        <br>  
        <label>ocupacion del padre de la esposa</label>
        <br>  
        <input type="text"  class="bor" name="Ocupacion_Pesposa" >
        <br>
        <br>  
        <label>ocupacion de la madre de la esposa</label>
        <br>  
        <input type="text" class="bor"  name="Ocupacion_Mesposa" >    
